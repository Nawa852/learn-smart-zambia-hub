...
import { BarChart3, PieChart, Calendar, Globe, Lightbulb } from 'lucide-react';
  ...
  <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 p-6">
    <div className="max-w-7xl mx-auto">
      <h1 className="text-4xl font-bold text-gray-900 mb-4 flex items-center gap-3">
        ...
        AI Study Progress Visualizer
      </h1>
      <p className="text-lg text-gray-600 mb-8">Visualizes ECZ progress with AI-powered analytics</p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          { icon: BarChart3, title: "AI-Powered Progress Visualizer", desc: "Displays ECZ progress with Moonshot AI", color: "orange" },
          { icon: PieChart, title: "Dynamic Progress Analyzer", desc: "Analyzes progress with GPT-4o", color: "blue" },
          ...
          { icon: Lightbulb, title: "AI-Powered Progress Recommender", desc: "Suggests focus areas with DeepSeek", color: "yellow" }
        ].map((feature, index) => (
