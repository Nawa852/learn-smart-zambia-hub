...
import { Shield, Terminal, Bug, Trophy, Lock, Eye, Wifi, Globe, Layers } from 'lucide-react';

const tabs: HubTab[] = [
  { id: 'overview',  label: 'Overview',     icon: Shield,   component: React.lazy(() => import('@/pages/CybersecurityDashboardPage')) },
  { id: 'labs',      label: 'Labs',         icon: Terminal, component: React.lazy(() => import('@/pages/CybersecurityLabsPage')) },
