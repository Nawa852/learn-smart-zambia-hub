...
import { Beaker, Eye, Calendar, Globe, Lightbulb } from 'lucide-react';
  ...
  <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-pink-50 p-6">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          { icon: Beaker, title: "AI-Powered Lab Simulator", desc: "Simulates ECZ experiments with Grok", color: "red" },
